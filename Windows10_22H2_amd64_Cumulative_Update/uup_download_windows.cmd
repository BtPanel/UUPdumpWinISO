@echo off
:: Generated on 2026-04-24 02:34:35 GMT
...
:START_PROCESS
title 19045.3208_amd64_zh-cn_multi_d9b8cfaf download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=d9b8cfaf-4904-4031-a2a5-81d80e25dac5&pack=zh-cn&edition=professional%%3Bcorecountryspecific%%3Bcore&aria2=2"
