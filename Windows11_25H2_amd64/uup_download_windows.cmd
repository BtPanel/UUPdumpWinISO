@echo off
:: Generated on 2026-03-23 13:07:29 GMT
...
:START_PROCESS
title 26200.8106_amd64_zh-cn_multi_05f1b1e6 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=05f1b1e6-9a75-4bd8-b858-dfe8edcbfb5b&pack=zh-cn&edition=professional%%3Bcore&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
