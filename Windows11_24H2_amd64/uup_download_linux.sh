#!/bin/bash
#Generated on 2026-03-11 03:08:45 GMT
...
aria2c --no-conf --console-log-level=warn --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=a42fc5c6-e458-4612-b1d2-38ea09064ab6&pack=zh-cn&edition=professional&aria2=2"
if [ $? != 0 ]; then
